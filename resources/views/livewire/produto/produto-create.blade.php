 <!-- Mudamos o style para cobrir 100% da largura e da altura visível da tela (100vh) -->
 <div style="background-color: #ffe798; min-height: 100vh; width: 100%;">
     <div class="py-5 m-0">

         <div class="container">
             <div class= "text-center mb-4">
                 <h2 class=" mb-0">Catalogação </h2>
                 <p class="fw-bold"> cadastro de produto </p>
             </div>
         </div>
         ...
         <div class="container col-md-8 mx-auto bg-warning-subtle rounded p-4 shadow-sm">
             <form class="row g-3" wire:submit.prevent='store'>
                 ...
                 <div class="text-center">
                     <button type="submit" class="btn btn-warning w-25 shadow-sm fw-bold">Salvar</button>
                 </div>
             </form>
         </div>
     </div>
